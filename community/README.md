...
| SimpleFin Sync | Bubbles840 | Automatically import bank and credit-card transactions from SimpleFin, with correct balances, pending reconciliation, and internal-transfer linking. Optional Telegram reports and commands, and automatic categorization of Amazon charges from their order emails. | community | verified | active | 1.14.0 | [Repo](https://github.com/Bubbles840/wealthfolio-simplefin-addon) |
